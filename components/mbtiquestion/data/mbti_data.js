var mbti_data = (function() {
    ...
    var recommendClassByJob = {
		'ISTJ': ['企業行政、管理人員及經理', '會計及財務總監', '警察及偵探', '法官', '律師', '醫生/牙醫', '計算機程序員、系統分析師及計算機專員', '軍官'],
		'ISFJ': ['室內裝潢設計師', '設計師', '護士', '主管及經理', '行政助理', '幼師/早教師', '社工/諮詢師', '律師助理', '神職人員/宗教工作者', '辦公室經理', '零售商人', '檔案管理員', '家政人員'],
		'INFJ': ['神職人員/宗教工作者', '教師', '內科醫生/牙醫', '特殊健康護理醫師，例如脊椎推拿治療師，反射療法治療師', '心理學家', '精神專家', '顧問及社會工作者', '音樂家和藝術家', '攝影師', '幼兒護理/兒童早期發展專家'],
		'INTJ': ['科學家', '工程師', '教授及教授', '醫護人員/牙醫', '企業戰略顧問及組織機構構建者', '商務管理者/經理人', '軍隊指揮', '律師/司法代理人', '法官', '計算機程序員，系統分析員及電腦專員'],
		'ISTP': ['警務人員及偵探', '犯罪心理學家', '計算機程序員、系統分析員及計算機專員', '工程師', '木匠', '商人', '飛行員、駕駛員、摩托車手', '運動員', '企業家'],
		'ISFP': ['藝術家', '音樂家/作曲家', '設計師', '幼師/兒童早教', '社工/諮詢師', '教師', '心理學家', '獸醫', '護林員', '兒科醫生'],
		'INFP': ['作家', '諮詢師/社工', '教師/教授', '心理學家', '精神病學家', '音樂家', '神職人員/宗教工作者'],
		'INTP': ['科學家-特別是物理，化學方面的', '攝影師', '戰略策劃', '數學家', '大學教授', '電腦程序員、統分析師、電腦動畫師以及計算機專業人員', '專業技術書籍作家', '工程師', '律師/代理人', '法官', '法律研究員', '森林/公園護林人'],
		'ESTP': ['銷售代表', '市場部', '警務人員/偵探', '軍醫/急診救治醫師', '電腦技師或網絡管理員', '計算機技術支持', '企業家'],
		'ESFP': ['藝術家，表演者和演員', '銷售代表', '諮詢師/社工', '幼教', '時裝設計師', '室內設計師', '顧問', '攝影師'],
		'ENFP': ['諮詢師', '心理學家', '企業家', '演員', '教師', '顧問', '政治家/外交家', '作家/記者', '電視主播', '電腦程序員，系統分析員或者電腦專家', '科學家', '工程師'],
		'ENTP': ['律師', '心理醫生', '企業家', '攝影師', '顧問', '工程師', '科學家', '演員', '銷售代表', '市場調研', '計算機程序員，系統分析員或計算機專員'],
		'ESTJ': ['軍官', '企業管理層', '警察/偵探', '法官', '金融業工作者', '教師', '銷售代表'],
		'ESFJ': ['家政', '護理', '教師', '行政管理', '幼師', '家庭醫師', '神職人員或其他宗教工作者', '辦公室經理', '諮詢師/社工', '簿記員/會計', '行政助理'],
		'ENFJ': ['協調人', '顧問', '心理諮詢工作者', '社會工作者/諮詢師', '教師', '神職人員', '銷售代表', '人力資源管理', '經理', '項目協調員', '政客/外交官', '作家'],
		'ENTJ': ['公司管理者；組織創建者', '個人企業家', '計算機諮詢師', '律師', '法官', '業務主管、經理', '大學教授以及大學裡的管理者']
	}
    ...
    return {
        ...
        // return an array contains recommended classes by jobID
